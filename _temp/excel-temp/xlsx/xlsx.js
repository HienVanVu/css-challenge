...
*/
  ...
  var _XLSIcv = rgbify([
    ...
    0xffffff /* 0x40 icvForeground ?? */, 0x000000 /* 0x41 icvBackground ?? */, 0x000000 /* 0x42 icvFrame ?? */, 0x000000 /* 0x43 icv3D ?? */, 0x000000 /* 0x44 icv3DText ?? */, 0x000000 /* 0x45 icv3DHilite ?? */, 0x000000 /* 0x46 icv3DShadow ?? */, 0x000000 /* 0x47 icvHilite ?? */, 0x000000 /* 0x48 icvCtlText ?? */, 0x000000 /* 0x49 icvCtlScrl ?? */, 0x000000 /* 0x4A icvCtlInv ?? */, 0x000000 /* 0x4B icvCtlBody ?? */, 0x000000 /* 0x4C icvCtlFrame ?? */, 0x000000 /* 0x4D icvCtlFore ?? */, 0x000000 /* 0x4E icvCtlBack ?? */, 0x000000 /* 0x4F icvCtlNeutral */, 0x000000 /* 0x50 icvInfoBk ?? */, 0x000000 /* 0x51 icvInfoText ?? */,
  ]);
  ...
  var CT_LIST = (function () {
    var o = {
      ...
      strs: {
        /* Shared Strings */ xlsx: "application/vnd.openxmlformats-officedocument.spreadsheetml.sharedStrings+xml",
      ...
      sheets: {
        /* Worksheet */ xlsx: "application/vnd.openxmlformats-officedocument.spreadsheetml.worksheet+xml",
        xlsb: "application/vnd.ms-excel.worksheet",
      },
      charts: {
        /* Chartsheet */ xlsx: "application/vnd.openxmlformats-officedocument.spreadsheetml.chartsheet+xml",
        xlsb: "application/vnd.ms-excel.chartsheet",
      },
      dialogs: {
        /* Dialogsheet */ xlsx: "application/vnd.openxmlformats-officedocument.spreadsheetml.dialogsheet+xml",
        xlsb: "application/vnd.ms-excel.dialogsheet",
      },
      macros: {
        /* Macrosheet (Excel 4.0 Macros) */ xlsx: "application/vnd.ms-excel.macrosheet+xml",
      ...
      if (R && R.f) {
        ...
        switch (Rn) {
          ...
          case "Lbl":
            ...
            supbooks[supbooks.length - 1].push(val);
            if (val.Name == "_xlnm._FilterDatabase" && val.itab > 0) if (val.rgce && val.rgce[0] && val.rgce[0][0] && val.rgce[0][0][0] == "PtgArea3d") FilterDatabases[val.itab - 1] = { ref: encode_range(val.rgce[0][0][1][2]) };
            break;
          case "ExternCount":
          ...
          case "数据":
            if (Rn[0].charAt(Rn[0].length - 2) === "/") {
              ...
              if (opts.cellFormula) {
                ...
                else for (i = 0; i < arrayf.length; ++i) if (R >= arrayf[i][0].s.r && R <= arrayf[i][0].e.r) if (C >= arrayf[i][0].s.c && C <= arrayf[i][0].e.c) q.F = arrayf[i][1];
              }
